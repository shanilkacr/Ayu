...
export const ComingSoonOverlay: React.FC = () => {
  return (
    <>
      <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 text-white text-center text-[32px] font-la-belle font-normal z-10 whitespace-nowrap max-md:text-2xl max-sm:text-xl max-sm:whitespace-normal">
        <h2>Coming Soon</h2>
      </div>
